...
export const translations = {
    ...
    fr: {
        ...
        step4_info_box: `
            ...
            <p style="margin-bottom: 14px;">La prochaine étape du processus (Étape 7) inclut un trade de vérification obligatoire requis par le broker dans le cadre de leur procédure de validation de compte. Ce trade doit être placé avec une taille de lot de <strong>1</strong>, ce qui est inhabituellement élevé pour une configuration initiale.</p>
